...
if __name__ == '__main__':
    ...
    dataset_csv_file = './dataset/estimation.csv'
    #model_weights = './model_weights/estimation.pkl'
...
model.save('estimation-classifier.h5', 
                overwrite=True,
...
model_new = tf.keras.models.load_model('estimation-classifier.h5')
